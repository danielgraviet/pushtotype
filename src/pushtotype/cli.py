...
def main(ctx, model_name, hotkey, audio_device, no_feedback, verbose, quiet, log_file):
    ...
    if ctx.invoked_subcommand is None:
        ...
        daemon = Daemon(
            ...
            feedback_style=cfg["feedback"].get("style", "chirp"),
            feedback_start_sound=cfg["feedback"].get("start_sound"),
            feedback_stop_sound=cfg["feedback"].get("stop_sound"),
            feedback_error_sound=cfg["feedback"].get("error_sound"),
